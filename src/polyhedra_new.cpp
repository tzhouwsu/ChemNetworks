...
void ChemNetworkNew::polyhedra_st(double *atmS1, double *atmT1, int nd1, int nd2, int nsolvent1, int nsolute1, int nAtomS1, int s1t1cutoffnum, int *s1t1a, int *s1t1b, double *s1t1cutoff, int pbc, double xside, double yside, double zside, FILE *outputPolys, int maxshellsize, double**edgebds, int whichatmT1, int whichatmdexT1)
{
...
void ChemNetworkNew::search_pbc_solute(int *shellist_indx, int *shellist, double *atmT1, double *atmS1box, int nd1, int nd2, int nsolvent1, int nsolute1, int nAtomS1, int s1t1cutoffnum, int *s1t1a, int *s1t1b, double *s1t1cutoff, int *eachnode_critatm, int whichatmT1, int whichatmdexT1)
{
...
double ChemNetworkNew::solvent_dist(double *atmS1, double *atmS1x, double *atmS1y, double *atmS1z, double *atmS1xy, double *atmS1yz, double *atmS1zx, double *atmS1xminy, double *atmS1minyz, double *atmS1zminx, double *atmS1xyz, double *atmS1xyminz,
...
double * ChemNetworkNew::pagerank(int ** adjM, int nodes, double damp, double tolerance) // regarded as a directed graph
{
...
void ChemNetworkNew::basearray(int n, int length, int *narray, int base)
{
...
void ChemNetworkNew::makeallpolys(poly **polylist)
{
...
ChemNetworkNew::poly * ChemNetworkNew::poly_create(char *name, int *edgelist, int nvtx, int nedge)
{
    int i;
    poly *newpoly;
    double damp=.85;
...
void ChemNetworkNew::poly_destroy(poly *polyhedron)
{
    int i;
...
int ChemNetworkNew::polymatch(poly **polylist, int **adjacency_matrix, double **shelldistmtx, int **temp_adjm, int shellsize, int numofpolies, double damp, double tolerance, int **possible_edgelist, int poss_edge_num)
{
    int *whichedges;
...
void ChemNetworkNew::pdfshell(double **shelldistmtx, int shellsize, FILE *outputshellpdf)
{
    int i, j;
...
int * ChemNetworkNew::findunique(int *list, int numinlist, int *numunique)
{
    int i, j, count;
    int matches;
    *numunique = 0;
