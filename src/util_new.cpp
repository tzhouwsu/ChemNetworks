...
int ChemNetworkNew::findf(FILE *fd, int n, ...){
...
double ChemNetworkNew::distance(double *atmS, int i, int j, int *sa, int *sb, int crt)
 {
...
double ChemNetworkNew::distanceMix(double *atmS1, double *atmS2, int i, int j, int *sa, int *sb, int crt)
 {
  double xcomp, ycomp, zcomp, result;
...
double ChemNetworkNew::angle(double dist, double dist2, double hyptns)
 {
...
double ChemNetworkNew::distanceOxOy(double *atmS, int i, int j, int opos)
 {
  double xcomp, ycomp, zcomp, result;
...
double ChemNetworkNew::dipole_angle(double *atmT, double *atmS, int i, int j, int *stb, int *sta, int crt, int opos, int h1pos, int h2pos)
{
...
double ChemNetworkNew::dihedral(double *atmS, int atm1, int atm2, int atm3, int atm4, int opos)
{                                   
...
double ChemNetworkNew::dihedral2(double *atmS, int atm1, int atm2, int atm3, int atm4, int opos)
{                                   
  double n1mag, n2mag, dotn1n2, dihAngle;
  double r12[4], r32[4], r23[4], r43[4], n1[4], n2[4];
...
int ChemNetworkNew::perm6(int v6[], int n, int i, int v2[], int *e){
...
void ChemNetworkNew::swap6(int v6[], int i, int j){
    int     t;
...
int ChemNetworkNew::perm5(int v5[], int n, int i, int v2[], int *e){
...
void ChemNetworkNew::swap5(int v5[], int i, int j){
    int     t;
...
int ChemNetworkNew::perm4(int v4[], int n, int i, int v2[], int *e){
...
void ChemNetworkNew::swap4(int v4[], int i, int j){
    int     t;
...
int ChemNetworkNew::perm3(int v3[], int n, int i, int v2[], int *e){
...
void ChemNetworkNew::swap3(int v3[], int i, int j){
    int     t;
